window.addEventListener('DOMContentLoaded', e =>{
  ...
  $('#tiket').click(function () {
    ...
    function agregar(){
      ...
      document.getElementById("productos").innerHTML +='<td>'+nuevoTiket.nombre+'</td><td>'+nuevoTiket.precio+'</td><td>'+nuevoTiket.cantidad+'</td>'+'</td><td>'+subtotal+'</td><td><btn id="boton01" value="Eliminar" title="Eliminar" class="btn btn-danger btn-delete"><i class="fas fa-trash"></i></td>'
